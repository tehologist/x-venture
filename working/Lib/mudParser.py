...
class mudparse:
    ...
    def __init__(self):
        ...
        self.sentstruct = {"verb": None, "directprep": None, "directnoun": 
...
#@+node:234.20061005200343:stripcap
    def stripcap(self, cmd):
        """Takes a string, removes instances of a, an and the, then 
        capitalizes and returns list of all elements."""
...
#@+node:234.20061005200926:getverb
    def getverb(self, cmd):
        """sets verb in dictionary to first first word in sentence. Removes
...
#@+node:234.20061005203939.1:getnoun
    def getnoun(self, cmd):
        """Will return list of all words till either list ends or element 
        is a preposition."""
...
#@+node:234.20061005203939.2:parsemain
    def parsemain(self, cmd):
        """Calls functions in order and assigns elements to dict based on 
        return."""
